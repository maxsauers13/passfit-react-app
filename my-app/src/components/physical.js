...
class PhysicalForm extends React.Component {
    ...
    render() {
        return <form onSubmit={(e) => this.handleSubmit(e)} class="formpage">
            <TitleQuestion label="1. Enter your gender (enter 0 for female or 1 for male)"></TitleQuestion>
            <input class="text-input" type="text" value={this.state.gender} onChange={(e) => this.handleChange(e, 1)} placeholder="Enter 0 or 1"/><br/>
            ...
            <QuestionInstruction label="b. Count the beats for 30 seconds."></QuestionInstruction>
            ...
            <input class="text-input" type="text" value={this.state.srpa} onChange={(e) => this.handleChange(e, 6)} placeholder="Enter level number"/><br/>
